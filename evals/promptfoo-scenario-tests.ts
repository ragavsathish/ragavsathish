...
const fitEvidence: Record<string, string[]> = {
  ...
  "cloud-architect": ["skill:AWS", "skill:Terraform", "skill:Kubernetes", "resource:K3sInternalsCrazyThings", "resource:UnderstandingKubernetesNetworking"],
...
function promptMarkers(scenario: Scenario): string[] {
  const markers: Record<string, string[]> = {
    ...
    "cloud-architect": ["Strong regulated cloud/platform architect", "K3s Internals", "Understanding Kubernetes Networking"],
